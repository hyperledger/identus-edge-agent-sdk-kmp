...
* [atala-prism-wallet-sdk-ts] - Repo that implements Atala PRISM for Browser and NodeJS platforms in Typescript.
* [atala-prism-building-blocks] - Repo that contains the platform Building Blocks.
