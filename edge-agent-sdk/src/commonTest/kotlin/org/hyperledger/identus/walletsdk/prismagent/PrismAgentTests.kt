...
class PrismAgentTests {
    ...
    fun setup() {
        ...
        connectionManager =
            ConnectionManagerImpl(mercuryMock, castorMock, plutoMock, mediationHandlerMock, mutableListOf())
        json = Json {
    ...
    fun testHandlePresentationDefinitionRequest_whenNotSupportedCredential_thenThrowInvalidCredentialError() = runTest {
        ...
        val msg = Json.decodeFromString<Message>(
            "{\"id\":\"00000000-685c-4004-0000-000036ac64ee\",\"piuri\":\"https://didcomm.atalaprism.io/present-proof/3.0/request-presentation\",\"from\":{\"method\":\"peer\",\"methodId\":\"asdfasdf\"},\"to\":{\"method\":\"peer\",\"methodId\":\"fdsafdsa\"},\"fromPrior\":null,\"body\":\"{}\",\"createdTime\":\"2024-03-08T19:27:38.196506Z\",\"expiresTimePlus\":\"2024-03-09T19:27:38.196559Z\",\"attachments\":[{\"id\":\"00000000-9c2e-4249-0000-0000c1176949\",\"mediaType\":\"application/json\",\"data\":{\"type\":\"io.iohk.atala.prism.walletsdk.domain.models.AttachmentBase64\",\"base64\":\"\"},\"format\":\"prism/jwt\"}],\"thid\":\"00000000-ef9d-4722-0000-00003b1bc908\",\"ack\":[]}"
        )
...
//        )
        ...
        assertFailsWith(PrismAgentError.InvalidCredentialError::class) {
            agent.handlePresentationDefinitionRequest(msg, credential)
        }
    }
    ...
    fun testHandlePresentationDefinitionRequest_whenWrongAttachmentType_thenThrowPresentationRequestAttachmentNotSupported() =
        runTest {
            ...
            val msg = Json.decodeFromString<Message>(
                "{\"id\":\"00000000-685c-4004-0000-000036ac64ee\",\"piuri\":\"https://didcomm.atalaprism.io/present-proof/3.0/request-presentation\",\"from\":{\"method\":\"peer\",\"methodId\":\"asdfasdf\"},\"to\":{\"method\":\"peer\",\"methodId\":\"fdsafdsa\"},\"fromPrior\":null,\"body\":\"{}\",\"createdTime\":\"2024-03-08T19:27:38.196506Z\",\"expiresTimePlus\":\"2024-03-09T19:27:38.196559Z\",\"attachments\":[{\"id\":\"00000000-9c2e-4249-0000-0000c1176949\",\"mediaType\":\"application/json\",\"data\":{\"type\":\"io.iohk.atala.prism.walletsdk.domain.models.AttachmentJsonData\",\"data\":\"\"},\"format\":\"prism/jwt\"}],\"thid\":\"00000000-ef9d-4722-0000-00003b1bc908\",\"ack\":[]}"
            )
            val credential = JWTCredential(
                "eyJhbGciOiJFUzI1NksifQ..x0SF17Y0VCDmt7HceOdTxfHlofsZmY18Rn6VQb0-r-k_Bm3hTi1-k2vkdjB25hdxyTCvxam-AkAP-Ag3Ahn5Ng"
            )
    ...
    @Test
    fun testHandlePresentationDefinitionRequest_whenAllCorrect_thenSendPresentationSubmissionCorrectly() = runTest {
        val apiMock = mock<Api>()
        `when`(apiMock.request(any(), any(), any(), any(), any()))
            .thenReturn(HttpResponse(200, "Ok"))
        ...
        val presentationSubmission = Json.decodeFromString<PresentationSubmission>(
            "{\"presentation_submission\":{\"id\":\"00000000-c224-45d7-0000-0000732f4932\",\"definition_id\":\"32f54163-7166-48f1-93d8-ff217bdb0653\",\"descriptor_map\":[{\"id\":\"wa_driver_license\",\"format\":\"jwt_vp\",\"path\":\"\$.verifiableCredential[0]\"}]},\"verifiableCredential\":[{\"vc\":{\"context\":[],\"type\":[\"VerifiableCredential\"],\"credentialSubject\":{\"additionalProp2\":\"Test3\",\"id\":\"did:prism:beea5234af46804714d8ea8ec77b66cc7f3e815c68abb475f254cf9c30626763:CscBCsQBEmQKD2F1dGhlbnRpY2F0aW9uMBAEQk8KCXNlY3AyNTZrMRIgeSg-2OO1JdnpzUOBitzIicXdfzeAcTfWAN-YCeuCbyIaIJQ4GTI30taViwchT3e0nLXBS43B4j9jlslKo2ZldXzjElwKB21hc3RlcjAQAUJPCglzZWNwMjU2azESIHkoPtjjtSXZ6c1DgYrcyInF3X83gHE31gDfmAnrgm8iGiCUOBkyN9LWlYsHIU93tJy1wUuNweI_Y5bJSqNmZXV84w\"}}}],\"proof\":{\"type\":\"EcdsaSecp256k1Signature2019\",\"created\":\"28 June 56155, 07:31:10\",\"proofPurpose\":\"authentication\",\"verificationMethod\":\"did:prism:asdfasdfasdfasdf#keys-1\",\"jws\":\"eyJhbGciOiJFUzI1NksifQ..x0SF17Y0VCDmt7HceOdTxfHlofsZmY18Rn6VQb0-r-k_Bm3hTi1-k2vkdjB25hdxyTCvxam-AkAP-Ag3Ahn5Ng\",\"challenge\":\"3045022100b1412c0f3fbbc5c876dde61141fa687f7f2faba834abce09c86c705a0b90200502206b67253fa5f80344c42dd84d236bbbb15d50a89b816fa55d5a6a742ccc860e23\"}}"
        )
        // Mock createPresentationSubmission response
        `when`(polluxMock.createPresentationSubmission(any(), any(), any(), any())).thenReturn(
        ...
        verify(connectionManagerMock).sendMessage(captor.capture())
        val sentMessage = captor.firstValue
        assertEquals(msg.to.toString(), sentMessage.from.toString())
        assertEquals(msg.from.toString(), sentMessage.to.toString())
        assertEquals(ProtocolType.DidcommPresentation.value, sentMessage.piuri)
        assertEquals(1, sentMessage.attachments.size)
        val attachment = sentMessage.attachments.first().data
        attachment as AttachmentBase64
        assertTrue(attachment::class == AttachmentBase64::class)
        val json =
            "{\"presentation_submission\":{\"id\":\"00000000-c224-45d7-0000-0000732f4932\",\"definition_id\":\"32f54163-7166-48f1-93d8-ff217bdb0653\",\"descriptor_map\":[{\"id\":\"wa_driver_license\",\"format\":\"jwt_vp\",\"path\":\"$.verifiableCredential[0]\"}]},\"verifiableCredential\":[{\"vc\":{\"context\":[],\"type\":[\"VerifiableCredential\"],\"credentialSubject\":{\"additionalProp2\":\"Test3\",\"id\":\"did:prism:beea5234af46804714d8ea8ec77b66cc7f3e815c68abb475f254cf9c30626763:CscBCsQBEmQKD2F1dGhlbnRpY2F0aW9uMBAEQk8KCXNlY3AyNTZrMRIgeSg-2OO1JdnpzUOBitzIicXdfzeAcTfWAN-YCeuCbyIaIJQ4GTI30taViwchT3e0nLXBS43B4j9jlslKo2ZldXzjElwKB21hc3RlcjAQAUJPCglzZWNwMjU2azESIHkoPtjjtSXZ6c1DgYrcyInF3X83gHE31gDfmAnrgm8iGiCUOBkyN9LWlYsHIU93tJy1wUuNweI_Y5bJSqNmZXV84w\"}}}],\"proof\":{\"type\":\"EcdsaSecp256k1Signature2019\",\"created\":\"28 June 56155, 07:31:10\",\"proofPurpose\":\"authentication\",\"verificationMethod\":\"did:prism:asdfasdfasdfasdf#keys-1\",\"jws\":\"eyJhbGciOiJFUzI1NksifQ..x0SF17Y0VCDmt7HceOdTxfHlofsZmY18Rn6VQb0-r-k_Bm3hTi1-k2vkdjB25hdxyTCvxam-AkAP-Ag3Ahn5Ng\",\"challenge\":\"3045022100b1412c0f3fbbc5c876dde61141fa687f7f2faba834abce09c86c705a0b90200502206b67253fa5f80344c42dd84d236bbbb15d50a89b816fa55d5a6a742ccc860e23\"}}"
        assertEquals(json, attachment.base64.base64UrlDecoded)
    }
    ...
    fun testHandlePresentationSubmission_whenAttachmentNotSupported_thenThrowsAttachmentTypeNotSupported() = runTest {
        ...
        assertFailsWith<PrismAgentError.AttachmentTypeNotSupported> {
            agent.handlePresentationSubmission(msg)
        }
    }

    @Test
    fun testHandlePresentationSubmission_whenProofHasNoChallenge_thenThrowsPresentationSubmissionDoesNotContainChallenge() =
        runTest {
            val apiMock = mock<Api>()
            `when`(apiMock.request(any(), any(), any(), any(), any()))
                .thenReturn(HttpResponse(200, "Ok"))
            ...
            val msgString =
                "{\"id\":\"00000000-621a-4ae9-0000-00002ffb05bf\",\"piuri\":\"https://didcomm.atalaprism.io/present-proof/3.0/presentation\",\"from\":{\"method\":\"peer\",\"methodId\":\"fdsafdsa\"},\"to\":{\"method\":\"peer\",\"methodId\":\"asdfasdf\"},\"fromPrior\":null,\"body\":\"{}\",\"createdTime\":\"2024-03-18T17:11:58.053680Z\",\"expiresTimePlus\":\"2024-03-19T17:11:58.058523Z\",\"attachments\":[{\"id\":\"00000000-ef5f-40c0-0000-0000d2674b80\",\"mediaType\":\"application/json\",\"data\":{\"type\":\"io.iohk.atala.prism.walletsdk.domain.models.AttachmentBase64\",\"base64\":\"\"},\"format\":\"prism/jwt\"}],\"thid\":\"00000000-ef9d-4722-0000-00003b1bc908\",\"ack\":[]}"
            val msg = Json.decodeFromString<Message>(msgString)

            assertFailsWith<PrismAgentError.PresentationSubmissionDoesNotContainChallenge> {
                agent.handlePresentationSubmission(msg)
            }
        }
    ...
    fun testHandlePresentationSubmission_whenAllCorrect_thenReturnTrue() = runTest {
        ...
        `when`(polluxMock.verifyPresentationSubmissionJWT(any(), any())).thenReturn(true)

        val vmAuthentication = DIDDocument.VerificationMethod(
            id = DIDUrl(
                DID("did", "prism", "607fffff16d079c8896e246613f9d10ab25f7c233830ff8a5c5fae2881c1c374"),
                fragment = "auth-1"
            ),
            controller = DID("did", "prism", "607fffff16d079c8896e246613f9d10ab25f7c233830ff8a5c5fae2881c1c374"),
            type = Curve.ED25519.value,
            publicKeyJwk = mapOf(
        ...
        val msgString =
            "{\"id\":\"00000000-621a-4ae9-0000-00002ffb05bf\",\"piuri\":\"https://didcomm.atalaprism.io/present-proof/3.0/presentation\",\"from\":{\"method\":\"peer\",\"methodId\":\"fdsafdsa\"},\"to\":{\"method\":\"peer\",\"methodId\":\"asdfasdf\"},\"fromPrior\":null,\"body\":\"{}\",\"createdTime\":\"2024-03-18T17:11:58.053680Z\",\"expiresTimePlus\":\"2024-03-19T17:11:58.058523Z\",\"attachments\":[{\"id\":\"00000000-ef5f-40c0-0000-0000d2674b80\",\"mediaType\":\"application/json\",\"data\":{\"type\":\"io.iohk.atala.prism.walletsdk.domain.models.AttachmentBase64\",\"base64\":\"\"},\"format\":\"prism/jwt\"}],\"thid\":\"00000000-ef9d-4722-0000-00003b1bc908\",\"ack\":[]}"
        val msg = Json.decodeFromString<Message>(msgString)

        assertTrue(agent.handlePresentationSubmission(msg))
    }
