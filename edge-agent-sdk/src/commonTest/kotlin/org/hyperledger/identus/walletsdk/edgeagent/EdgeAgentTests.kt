...
class EdgeAgentTests {
    ...
    fun testHandlePresentationDefinitionRequest_whenAnoncreds_thenSendPresentationSubmissionCorrectly() =
        runTest {
            ...
            val anoncredPresentationDefinitionRequest = """{"nonce":"","name":"anoncreds_presentation_request","version":"0.1","requested_predicates":{"age":{"name":"age","p_type":">","p_value":"18"}},"requested_attributes":{}}"""
