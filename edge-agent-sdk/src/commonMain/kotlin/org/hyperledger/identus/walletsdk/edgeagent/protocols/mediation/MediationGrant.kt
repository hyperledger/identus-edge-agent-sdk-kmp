...
/**
 * The MediationGrant class represents a mediation grant in the Identus architecture.
...
class MediationGrant {
    ...
    /**
     * Represents a mediation grant in the Identus architecture.
     * A mediation grant is used for granting permission to mediate a specific request.
     *
     * @property id The unique identifier of the mediation grant.
     * @property type The type of the mediation grant.
     ...
     * It is used for secure, decentralized communication in the Identus architecture.
     *
     * @see Message
     */
    @Serializable
