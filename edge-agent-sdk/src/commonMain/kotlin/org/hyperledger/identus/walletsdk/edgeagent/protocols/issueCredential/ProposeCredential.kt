...
data class ProposeCredential @JvmOverloads constructor(
     ...
     * which is used for secure, decentralized communication in the Identus architecture. The function sets the id, piuri,
...
/**
 * This method builds a ProposeCredential object based on the provided parameters. The ProposeCredential represents a proposal to issue a credential in the Identus architecture
